...
import orderIcon from "../../statics/Images/filter.png";
import arrowIcon from "../../statics/Images/arrow.svg";
        ...
        <div className="nav-container">
          <div>
            ...
            <div
              className={
                toggleFilter
                  ? "nav-disp-dropdown nav-disp-dropdown-show element-to-disappear"
                  : "nav-disp-dropdown"
              }
            >
